...
const (
	...
	ConfigService_GetServiceHealth_FullMethodName = "/svcpb.ConfigService/GetServiceHealth"
)
...
type ConfigServiceClient interface {
	...
	// GetServiceHealth проверяет, что Landing отвечает на сервисные запросы.
...
func (c *configServiceClient) GetServiceHealth(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, ConfigService_GetServiceHealth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedConfigServiceServer) GetServiceHealth(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _ConfigService_GetServiceHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(ConfigServiceServer).GetServiceHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var ConfigService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ConfigService_GetServiceHealth_Handler,
		},
	},
